...
echo
echo Continue to create GitHub TAP GitOps Repo eks-use1
echo     https://github.com/tanzupro/eks-use1
echo
...
git add .
git commit -am "."
gh repo create eks-use1 --private
git remote add origin https://github.com/tanzupro/eks-use1
git branch -M main
